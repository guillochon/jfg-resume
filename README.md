...
- **GitHub Actions:** add repository secret **`ADS_KEY`**; [`pages.yml`](.github/workflows/pages.yml) passes it into the build. Secrets are not available to workflows from forks.
